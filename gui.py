...
class GUI:
    ...
    def drone_map_image(self, colour=BLUE, background=WHITE):
        ...
        letter_s = pygame.transform.scale(pygame.image.load("drona.png"), (COLUMN_SIZE, ROW_SIZE))
        image.blit(letter_s, (self.service.initial_y * COLUMN_SIZE, self.service.initial_x * ROW_SIZE))
        letter_f = pygame.transform.scale(pygame.image.load("drona.png"), (COLUMN_SIZE, ROW_SIZE))
